...
func (aq *AccountQuery) QueryUsername() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, account.UsernameTable, account.UsernameColumn),
		)
...
func (aq *AccountQuery) Clone() *AccountQuery {
	...
	return &AccountQuery{
		...
		withUsername: aq.withUsername.Clone(),
...
func (aq *AccountQuery) WithUsername(opts ...func(*UserQuery)) *AccountQuery {
	query := &UserQuery{config: aq.config}
	for _, opt := range opts {
		opt(query)
	}
	aq.withUsername = query
	return aq
}
...
func (aq *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := aq.withUsername; query != nil {
		if err := aq.loadUsername(ctx, query, nodes, nil,
			func(n *Account, e *User) { n.Edges.Username = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AccountQuery) loadUsername(ctx context.Context, query *UserQuery, nodes []*Account, init func(*Account), assign func(*Account, *User)) error {
