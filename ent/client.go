...
import (
	...
	"github.com/guilleamutio/go4money/ent/migrate"
...
// QueryUsername queries the username edge of a Account.
func (c *AccountClient) QueryUsername(a *Account) *UserQuery {
