...
func (ac *AccountCreate) SetUsernameID(id int) *AccountCreate {
	ac.mutation.SetUsernameID(id)
	return ac
}

// SetUsername sets the "username" edge to the User entity.
func (ac *AccountCreate) SetUsername(u *User) *AccountCreate {
	return ac.SetUsernameID(u.ID)
}
...
func (ac *AccountCreate) check() error {
	...
	if _, ok := ac.mutation.UsernameID(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`ent: missing required edge "Account.username"`)}
	}
	return nil
}
...
func (ac *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.UsernameIDs(); len(nodes) > 0 {
