...
func (e AccountEdges) UsernameOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.Username == nil {
...
// QueryUsername queries the "username" edge of the Account entity.
func (a *Account) QueryUsername() *UserQuery {
	return (&AccountClient{config: a.config}).QueryUsername(a)
}
