...
// Source: github.com/guilleamutio/go4money/db/sqlc (interfaces: Store)
...
// GetAccountUpdated mocks base method.
func (m *MockStore) GetAccountUpdated(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountUpdated", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountUpdated indicates an expected call of GetAccountUpdated.
func (mr *MockStoreMockRecorder) GetAccountUpdated(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountUpdated", reflect.TypeOf((*MockStore)(nil).GetAccountUpdated), arg0, arg1)
}
...
func (mr *MockStoreMockRecorder) ListAllAccounts(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListAllEntries(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListAllTransfers(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStore) ListTransfersFromAccount(arg0 context.Context, arg1 int64) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfersToAccount(arg0 context.Context, arg1 int64) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
