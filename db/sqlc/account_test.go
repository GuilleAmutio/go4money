...
func TestGetAccountUpdated(t *testing.T) {
	account1 := createRandomAccount(t)
	...
	account3, err := testQueries.GetAccountUpdated(context.Background(), account1.ID)
	...
	require.NotEqual(t, account1.Balance, account3.Balance)
